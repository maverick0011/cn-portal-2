        ...
        <div className="relative">
          ...
          >
            <form className="space-y-4" onSubmit={handleLogin}>
               ...
               {error && (
                 <p className="text-red-600 text-[11px] font-medium bg-red-50 dark:bg-red-950/20 p-3 rounded-lg border border-red-100 dark:border-red-900/30">
                   {error}
                 </p>
               )}
               ...
               <button 
                type="submit"
                disabled={loading}
                className="w-full h-[48px] bg-primary text-white rounded-md font-black text-xl flex items-center justify-center hover:bg-blue-700 transition-colors disabled:opacity-50"
               >
                 {loading ? (
               ...
               <div className="text-center pt-2">
                  <button 
                    ...
                    className="inline-flex items-center justify-center h-[48px] px-8 bg-[#42b72a] text-white rounded-md font-bold text-lg hover:bg-[#36a420] transition-colors w-full sm:w-auto"
                  >
                    Create new account
                  </button>
               </div>
